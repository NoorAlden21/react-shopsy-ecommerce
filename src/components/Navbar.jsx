...
import Logo from "../assets/ecommerce-logo-design_624194-152.jpg";
          ...
          <div className="flex justify-between items-center gap-4">
            <div className="relative group hidden sm:block">
              <input
                type="text"
                placeholder="search"
                className="bg-white text-gray-700 w-[200px] sm:w-[200px] group-hover:w-[300px] transition-all duration-300
